...
export default async function Home({ searchParams }: PageProps<"/">) {
  ...
  // "Todas las marcas" (Decisión 13) es ahora el default de entrada (sin `?brand=` en la
  // URL) además de un valor explícito — sin filtro de brand_id, mezcla el contenido de
  // todas las marcas. Cualquier slug real (?brand=mastery-haus, ?brand=sofia-contreras)
  // sigue aislando esa marca sola.
  const isAllBrands = brandSlug === ALL_BRANDS_SLUG || brandSlug === undefined;
